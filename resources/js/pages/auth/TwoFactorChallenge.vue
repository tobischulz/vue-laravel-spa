    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-gray-100 shadow-md overflow-hidden rounded-lg">
        <form @submit.prevent="login">
            <div>
                ...
                <input v-model="code" class="p-2 rounded-md shadow-sm bg-white border-gray-900 text-gray-400 block mt-1 w-full" id="code" type="text" name="code" required="required" autofocus="autofocus">
            </div>
