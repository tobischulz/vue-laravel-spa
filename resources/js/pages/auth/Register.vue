    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-gray-100 shadow-md overflow-hidden sm:rounded-lg">
        <form @submit.prevent="register">
            <div>
                ...
                <input v-model="data.name" class="p-2 rounded-md shadow-sm bg-white border-gray-900 text-gray-400 block mt-1 w-full" id="name" type="text" name="name" required="required" autofocus="autofocus">
            ...
            <div class="mt-4">
                ...
                <input v-model="data.password_confirmation" class="p-2 rounded-md shadow-sm bg-white border-gray-900 text-gray-400 focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50 block mt-1 w-full" id="password_confirmation" type="password" name="password_confirmation" required="required" autocomplete="current-password">
